document.addEventListener("DOMContentLoaded", () => {
  ...
  // Helper function for woof animation
  const triggerWoof = () => {
    // Prevent multiple rapid triggers
    if (propeller.classList.contains("spinning")) return;

    // Play woof sound
    const woofSound = new Audio(
    ...
    // Stop propeller after 2 seconds
    setTimeout(() => {
  ...
  woofBtn.addEventListener("click", triggerWoof);

  // Add touch events for mobile
  woofBtn.addEventListener("touchstart", (e) => {
